...
const FeaturesPage = () => {
  ...
  const patientFeatures = [
    ...
    },
    {
      ...
      title: "Lab Tests",
      description: "Request and view your laboratory test results.",
      action: "View Lab Tests",
  ...
  const doctorFeatures = [
    ...
    },
    {
      ...
      description: "View and update patient medical histories.",
    ...
    },
    {
      ...
      icon: <FaFlask className="text-4xl" />,
      title: "Lab Tests",
      description: "Assign and manage patient laboratory tests.",
      action: "Manage Lab Tests",
      onClick: () => navigate('/doctor/labtests')
    }
  ];
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50">
        ...
        <div className="relative min-h-[85vh] bg-gradient-to-br overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div className="absolute top-0 left-0 w-full h-full">
              <div className="absolute top-0 left-0 w-72 h-72 bg-gradient-to-br from-green-100/80 to-green-200/60 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
              <div className="absolute top-0 right-0 w-72 h-72 bg-gradient-to-bl from-blue-100/80 to-green-100/60 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
              <div className="absolute -bottom-8 left-20 w-72 h-72 bg-gradient-to-tr from-yellow-100/80 to-green-100/60 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
              <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-br from-white/30 to-green-100/20 rounded-full blur-3xl transform -translate-x-1/2 -translate-y-1/2 animate-float"></div>
              <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-to-tl from-green-200/30 to-white/20 rounded-full blur-3xl animate-float animation-delay-2000"></div>
              <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-gradient-to-r from-green-100/40 to-transparent rounded-full blur-2xl transform -translate-x-1/2 -translate-y-1/2 animate-float animation-delay-4000"></div>
              <div className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-l from-[#77B254]/10 to-transparent rounded-full blur-3xl animate-float animation-delay-6000"></div>
              <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(circle at 1px 1px, #77B254 1px, transparent 0)', backgroundSize: '40px 40px' }} />
            </div>
          </div>
                  ...
                  <form onSubmit={handleSearch} className="relative">
                    <div className="relative flex items-center ">
                      <input
                        ...
                        className="w-full px-6 py-4 pr-12 text-gray-700 bg-white/95 backdrop-blur-md rounded-full shadow-xl focus:outline-none text-lg placeholder-gray-400 border-none"
                      />
                      <button
                        type="submit"
                        className="absolute right-4 p-2 text-gray-600 hover:text-[#77B254] transition-colors duration-300"
                      >
                    ...
                    <div className="mt-4 flex flex-wrap justify-center gap-2 ">
                      {userType === 'DOCTOR'
                        ? ['Appointments', 'Patients', 'Consultations', 'Reports', 'Medical History', 'Lab Tests'].map((term, index) => (
                            <motion.button
                              key={term}
                              ...
                              className="px-4 py-1 bg-[#77B254] hover:bg-white/30 hover:text-[#77B254] rounded-full text-sm text-white backdrop-blur-sm transition-colors duration-300"
                            >
                              {term}
                            </motion.button>
                          ))
                        : ['Appointments', 'Doctors', 'Emergency', 'Lab Tests', 'Medical History'].map((term, index) => (
                            <motion.button
                              key={term}
                              initial={{ opacity: 0, y: 10 }}
                              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="container mx-auto">
                ...
                >
                  <div className="relative bg-white rounded-2xl p-8 h-full">
                    ...
                    <div className="relative mb-6">
                      <div className="w-16 h-16 bg-gradient-to-br from-[#77B254] to-green-600 rounded-2xl flex items-center justify-center text-white transform group-hover:rotate-6 transition-transform duration-300 shadow-lg">
                        {feature.icon}
                      </div>
                      <div className="absolute -inset-2 bg-[#77B254]/10 rounded-2xl blur-xl opacity-0 group-hover:opacity-70 transition-opacity duration-300" />
                    </div>
                    <div className="relative z-10">
                      <h3 className="text-2xl font-bold text-gray-800 mb-4 group-hover:text-[#77B254] transition-colors duration-300">
                        {feature.title}
                      </h3>
                      ...
                      <div className="mt-auto">
                        <button 
                          ...
                          className="relative inline-flex items-center justify-center w-full px-6 py-3 text-base font-medium rounded-xl text-[#77B254] hover:text-white transition-all duration-300 ease-in-out bg-gradient-to-r from-[#77B254]/10 to-green-600/10 hover:from-[#77B254] hover:to-green-600 group overflow-hidden"
                        >
            ...
            >
              <button 
                ...
                className="inline-flex items-center px-8 py-3 rounded-full text-[#77B254] hover:text-white font-medium bg-[#77B254]/10 hover:bg-[#77B254] transition-all duration-300 group"
              >
                {showAllServices ? 'Show Less' : 'View All Services'}
                <svg 
                  className={`ml-2 w-5 h-5 transition-transform duration-300 ${showAllServices ? 'rotate-180' : ''}`}
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  name: "John Doe",
                  rating: 5,
                  review: "Managing my medical history has never been easier. Great platform!",
                  date: "3 days ago"
                }
              ].map((review, index) => (
                <motion.div
            ...
            >
              <button 
                ...
                className="inline-flex items-center px-8 py-3 rounded-full text-white font-medium bg-[#77B254] hover:bg-green-600 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                Write a Review
                <svg 
        ...
        <motion.button
          ...
          className={`fixed bottom-8 right-8 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 ${showScrollTop ? 'visible' : 'invisible'}`}
        >
        ...
        <div className="bg-gradient-to-r py-16">
          <div className="container mx-auto px-4 text-center text-[#77B254]">
            ...
            <button className="px-6 py-2 font-medium transition-all duration-300 rounded-lg bg-gradient-to-r from-[#77B254] to-[#69a048] text-white hover:from-[#69a048] hover:to-[#77B254] hover:shadow-lg">
              Get Started Now
            </button>
          </div>
        </div>
